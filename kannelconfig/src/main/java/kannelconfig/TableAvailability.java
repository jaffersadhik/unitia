...
public class TableAvailability {
	...
	private static final String KANNEL_CONFIG = "CREATE TABLE kannel_config (smscid varchar(40) PRIMARY KEY,ip varchar(1000) NOT NULL,port decimal(10,0),username varchar(40) NOT NULL,password varchar(40) NOT NULL,sessioncount decimal(2,0) default 1,kannelid varchar(50) default 'kannel1',routeclass varchar(1),itime timestamp default CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8";
