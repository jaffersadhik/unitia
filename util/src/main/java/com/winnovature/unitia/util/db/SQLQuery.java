...
public class SQLQuery {
	...
	public static final String CREATE_ROUTE_TABLE = "create table route(id INT PRIMARY KEY AUTO_INCREMENT,routegroup_trans varchar(50) ,routegroup_promo  varchar(50) ,superadmin varchar(21),admin varchar(21),username varchar(21),operator varchar(2),circle varchar(2),index(superadmin,admin,username,operator,circle))";

	public static final String CREATE_CREDIT_DOMESTIC_TABLE = "create table credit_domestic(id INT PRIMARY KEY AUTO_INCREMENT,credit_trans numeric(4,2) default '1.00' ,credit_promo numeric(4,2) default '1.00' ,superadmin varchar(21),admin varchar(21),username varchar(21),operator varchar(2),circle varchar(2),index(superadmin,admin,username,operator,circle))";
	
	public static final String CREATE_CREDIT_INTERNATIONAL_TABLE = "create table credit_international(id INT PRIMARY KEY AUTO_INCREMENT,credit numeric(4,2) default '1.00' ,superadmin varchar(21),admin varchar(21),username varchar(21),countrycode varchar(10),index(superadmin,admin,username,countrycode))";

	public static final String CREATE_INTL_ROUTE_TABLE = "create table international_route(id INT PRIMARY KEY AUTO_INCREMENT,routegroup varchar(50),superadmin varchar(21),admin varchar(21),username varchar(21),countrycode varchar(10),index(superadmin,admin,username,countrycode))";

	public static final String INSERT_ROUTE_TABLE = "insert into route(routegroup_trans,routegroup_promo,superadmin,admin,username,operator,circle ) values(?,?,?,?,?,?,?)";

	public static final String INSERT_CREDIT_DOMESTIC_TABLE = "insert into credit_domestic(credit_trans,credit_promo,superadmin,admin,username,operator,circle ) values(?,?,?,?,?,?,?)";

	public static final String CREATE_KANNEL_LOADBALANCER = "create table loadbalancer_kannel(ip varchar(50) primary key)";
	
	public static final String INSERT_KANNEL_LOADBALANCER = "insert into loadbalancer_kannel(ip) values(?)";
	
	public static final String CREATE_DN_LOADBALANCER = "create table loadbalancer_dn(ip varchar(150) primary key,port int(6))";
	...
	public static final String CREATE_VSMSC_LOADBALANCER = "create table loadbalancer_vsmsc(ip varchar(50) primary key,port int(6))";
	...
	public static final String SELECT_CREDIT_DOMESTIC_TABLE = "select credit_trans,credit_promo,superadmin,admin,username,operator,circle from credit_domestic";

	public static final String SELECT_CREDIT_INTERNATIONAL_TABLE = "select credit,superadmin,admin,username,countrycode from credit_international";
	...
	public static final String CREATE_HTTP_LOADBALANCER = "create table loadbalancer_http(ip varchar(100) primary key,port int(6))";
	...
	public static final String CREATE_AUTHORIZED_IP_TABLE = "create table users_authorized_ip_pattern( username varchar(16),ip_pattern varchar(100))";
	
	public static final String CREATE_APPS_AUTHORIZED_IP_TABLE = "create table apps_authorized_ip_pattern( modulename  varchar(16),ip_pattern varchar(100))";
