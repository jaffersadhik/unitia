...
public class SMSProcessor {
	...
	public void setDLRURL()  throws Exception{
		...
		String [] params=
		{
				...
				URLEncoder.encode(msgmap.get(MapKeys.ACKID_LIST)==null?"":msgmap.get(MapKeys.ACKID_LIST).toString(),"UTF-8")//35
...
public void setDLRURL(Map<String,Object> splitmap)  throws Exception{
		...
		String [] params=
		{
				...
				URLEncoder.encode(attemtcount,"UTF-8"),//33
				URLEncoder.encode(msgmap.get(MapKeys.SENDERID)==null?"":msgmap.get(MapKeys.SENDERID).toString(),"UTF-8"),//34
				URLEncoder.encode(msgmap.get(MapKeys.ACKID_LIST)==null?"":msgmap.get(MapKeys.ACKID_LIST).toString(),"UTF-8")//34
