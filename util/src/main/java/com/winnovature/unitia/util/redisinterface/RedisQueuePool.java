...
public class RedisQueuePool {
	...
	private void createPool() {
		if(redisid.equals("redisinterfacequeue1")){
			pool= new RedisPool().createJedisPool(Prop.getInstance().getRedisInterfaceQueue1Prop());
	
		}else if(redisid.equals("redisinterfacequeue2")){
			pool= new RedisPool().createJedisPool(Prop.getInstance().getRedisInterfaceQueue2Prop());
	
		}else if(redisid.equals("redisinterfacequeue3")){
			pool= new RedisPool().createJedisPool(Prop.getInstance().getRedisInterfaceQueue3Prop());
	
		}else if(redisid.equals("redisinterfacequeue4")){
			pool= new RedisPool().createJedisPool(Prop.getInstance().getRedisInterfaceQueue4Prop());
	
		}else if(redisid.equals("redisinterfacequeue5")){
			pool= new RedisPool().createJedisPool(Prop.getInstance().getRedisInterfaceQueue5Prop());
	
		}else if(redisid.equals("redisinterfacequeue6")){
			pool= new RedisPool().createJedisPool(Prop.getInstance().getRedisInterfaceQueue6Prop());
