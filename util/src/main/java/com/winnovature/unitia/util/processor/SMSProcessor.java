...
public class SMSProcessor {
	...
	private String getKey(String superadmin,String admin,String username, String operator, String circle, int logic) {
		...
		case 2:
			 return CONJUNCTION+superadmin+CONJUNCTION+admin+CONJUNCTION+username+CONJUNCTION+operator+CONJUNCTION+Route.NULL+CONJUNCTION;
		case 3:
			 return CONJUNCTION+superadmin+CONJUNCTION+admin+CONJUNCTION+username+CONJUNCTION+Route.NULL+CONJUNCTION+circle+CONJUNCTION;
		case 4:
			 return CONJUNCTION+superadmin+CONJUNCTION+admin+CONJUNCTION+username+CONJUNCTION+Route.NULL+CONJUNCTION+Route.NULL+CONJUNCTION;
		case 5:
			 return CONJUNCTION+superadmin+CONJUNCTION+admin+CONJUNCTION+Route.NULL+CONJUNCTION+operator+CONJUNCTION+circle+CONJUNCTION;
		case 6:
			 return CONJUNCTION+superadmin+CONJUNCTION+admin+CONJUNCTION+Route.NULL+CONJUNCTION+operator+CONJUNCTION+Route.NULL+CONJUNCTION;
		case 7:
			 return CONJUNCTION+superadmin+CONJUNCTION+admin+CONJUNCTION+Route.NULL+CONJUNCTION+Route.NULL+CONJUNCTION+circle+CONJUNCTION;
		case 8:
			 return CONJUNCTION+superadmin+CONJUNCTION+admin+CONJUNCTION+Route.NULL+CONJUNCTION+Route.NULL+CONJUNCTION+Route.NULL+CONJUNCTION;
		case 9:
			 return CONJUNCTION+superadmin+CONJUNCTION+Route.NULL+CONJUNCTION+Route.NULL+CONJUNCTION+operator+CONJUNCTION+circle+CONJUNCTION;
		case 10:
			 return CONJUNCTION+superadmin+CONJUNCTION+Route.NULL+CONJUNCTION+Route.NULL+CONJUNCTION+operator+CONJUNCTION+Route.NULL+CONJUNCTION;
		case 11:
			 return CONJUNCTION+superadmin+CONJUNCTION+Route.NULL+CONJUNCTION+Route.NULL+CONJUNCTION+Route.NULL+CONJUNCTION+circle+CONJUNCTION;
		case 12:
			 return CONJUNCTION+superadmin+CONJUNCTION+Route.NULL+CONJUNCTION+Route.NULL+CONJUNCTION+Route.NULL+CONJUNCTION+Route.NULL+CONJUNCTION;
		case 13:
			 return CONJUNCTION+Route.NULL+CONJUNCTION+Route.NULL+CONJUNCTION+Route.NULL+CONJUNCTION+operator+CONJUNCTION+circle+CONJUNCTION;
		case 14:
			 return CONJUNCTION+Route.NULL+CONJUNCTION+Route.NULL+CONJUNCTION+Route.NULL+CONJUNCTION+operator+CONJUNCTION+Route.NULL+CONJUNCTION;
		case 15:
			 return CONJUNCTION+Route.NULL+CONJUNCTION+Route.NULL+CONJUNCTION+Route.NULL+CONJUNCTION+Route.NULL+CONJUNCTION+circle+CONJUNCTION;
		case 16:
			 return CONJUNCTION+Route.NULL+CONJUNCTION+Route.NULL+CONJUNCTION+Route.NULL+CONJUNCTION+Route.NULL+CONJUNCTION+Route.NULL+CONJUNCTION;
